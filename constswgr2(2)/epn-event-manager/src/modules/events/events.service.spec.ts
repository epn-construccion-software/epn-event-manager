...
describe('EventsService', () => {
  ...
  it('should return five zero values when all repositories are empty', async () => {
    createRepo.count.mockResolvedValue(0);
    updateRepo.count.mockResolvedValue(0);
    deleteRepo.count.mockResolvedValue(0);
    queryRepo.count.mockResolvedValue(0);
  ...
  it('should keep every field numeric when only some repositories have data', async () => {
    createRepo.count.mockResolvedValue(0);
    updateRepo.count.mockResolvedValue(5);
    deleteRepo.count.mockResolvedValue(0);
    queryRepo.count.mockResolvedValue(2);
  ...
  it('should normalize non-numeric repository counts to zero instead of NaN', async () => {
    createRepo.count.mockResolvedValue(null as unknown as number);
    updateRepo.count.mockResolvedValue(undefined as unknown as number);
    deleteRepo.count.mockResolvedValue('not-a-number' as unknown as number);
